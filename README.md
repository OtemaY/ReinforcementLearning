...
that is used to store past experiences in a replay buffer and sample batches in order to train the Q-network. 

This is useful in a way that it stabilizes training by breaking correlations between consecutive samples and makes use of past experiences effectively. The target network, which is a
...
[1] Deep Reinforcement Learning Part 1: DQN; Accessed: https://towardsdatascience.com/welcome-to-deep-reinforcement-learning-part-1-dqn-c3cab4d41b6b.
